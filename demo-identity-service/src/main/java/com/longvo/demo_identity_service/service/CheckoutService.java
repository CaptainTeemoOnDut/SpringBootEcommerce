...
public class CheckoutService {
    ...
    public CheckoutService(UserRepository userRepository,
                           @Value("${stripe.secret.key}") String secretKey, OrderRepository orderRepository, OrderService orderService, VNPayService vnPayService, OrderGroupRepository orderGroupRepository, PaymentTransactionRepository paymentTransactionRepository) {
    ...
    public boolean processPaymentIpn(
        ...
        if ("00".equals(responseCode)) {
            ...
            orderGroup.setPaidAt(paidAt);

            PaymentTransaction paymentTransaction = paymentTransactionRepository.findByOrderGroupId(orderGroupId);
            ...
            orderService.updateStatusByOrderGroupId(orderGroupId, OrderStatus.PAID);
